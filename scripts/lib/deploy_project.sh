...
for f in http_bridge.py activate_project.sh git_fetch.sh glossary_refresh.sh glossary_worker.sh reindex_local_repo.sh requirements.txt requirements.lock openai_backend.py bedrock_converse.py openai_glossary.py glossary_config.py glossary-requirements.lock setup_glossary.sh; do
