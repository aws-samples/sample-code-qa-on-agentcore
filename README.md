...
这是用于学习和参考的非生产示例。部署前，请与安全和法务团队确认满足所在组织的安全、监管与合规要求；
用于生产环境前，还需完成额外的安全测试并补齐运维控制。
...
```bash
git clone https://github.com/aws-samples/sample-code-qa-on-agentcore.git
cd sample-code-qa-on-agentcore
./scripts/install.sh
```
...
问题、使用疑问和功能建议请提交到 [GitHub Issues](https://github.com/aws-samples/sample-code-qa-on-agentcore/issues)，欢迎中英文贡献。
另见[行为准则](CODE_OF_CONDUCT.md)、[安全问题报告](SECURITY.md)和[贡献者](https://github.com/aws-samples/sample-code-qa-on-agentcore/graphs/contributors)。

### 许可证

[MIT-0](LICENSE)。第三方许可信息见 [THIRD-PARTY-LICENSES](THIRD-PARTY-LICENSES)。
...
This is a non-production educational sample. Before deployment, work with your security and legal
teams to meet your organization's security, regulatory and compliance requirements. Production use
requires additional security testing and operational controls.
...
Use [GitHub Issues](https://github.com/aws-samples/sample-code-qa-on-agentcore/issues) for bugs, questions, and feature proposals.
Contributions in English or Chinese are welcome. See the [Code of Conduct](CODE_OF_CONDUCT.md),
[security reporting instructions](SECURITY.md), and [contributors](https://github.com/aws-samples/sample-code-qa-on-agentcore/graphs/contributors).

### License

[MIT-0](LICENSE). Third-party licensing information is in [THIRD-PARTY-LICENSES](THIRD-PARTY-LICENSES).
