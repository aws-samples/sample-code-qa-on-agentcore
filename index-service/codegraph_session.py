...
class CodegraphSession:
    ...
    def _scan_orphan_servers(self) -> tuple[set[int], bool]:
        ...
        for q in queries:
            try:
                # Fixed pgrep executable and argv list; workspace regex is escaped above.
    ...
    def _reap_orphan_servers(self) -> bool:
        ...
        for i in range(attempts):
            ...
            if queried_ok and not pids:
                ...
                # Required fork/exec settle barrier in this four-attempt reaper.
            ...
            # Bounded settle barrier: let SIGKILL take effect and a late fork surface.
            # nosemgrep: arbitrary-sleep
            time.sleep(settle_s)
